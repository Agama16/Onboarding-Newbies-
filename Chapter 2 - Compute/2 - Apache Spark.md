...
*************************** שאלות סקילה 2 ***************************
1. האם אפשר לעשות predicate pushdown לכל סוגי הקונקטורים? אפשר לhive / iceberg connectors ובכללי לקטלוגים בפורמט סכמתי \ עם סטטיסטיקות מטא-דאטה שאפשר לעשות pushdown עליהם. לא לכל קונקטור. 
