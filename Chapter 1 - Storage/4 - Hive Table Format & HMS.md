...
- בעזרת scaling - ניצור יותר מhiveserver אחד שיתמודד עם בקשות של לקוחות או ניצור כמה instances של הHMS כדי לטפל בבקשות במקביל ולא להעמיס על שרת אחד.
- נגביל את מספר החיבורים האפשריים במקביל
- לשים locks על נתונים כדי למנוע סתירה בין נתונים כששני לקוחות עושים פעולות במקביל.
