...
6. **Interoperability & Ecosystem:**  Describe how catalogs and formats enable
   ...
   3. האם קטלוגים נוספים coupled לשכבת אחסון מסוימת? כן לסוגי אחסון, databricks unity catalogs מקושר לcloud object storage כמו AWS S3' GEN2 ועוד. הרוב לא (iceberg,hive ועוד מכילים קטלוגים שיכולים לעבוד עם HDFS, S3 ואחסונים אחרים אבל השימוש על האדופ מחייב שימוש באחסונים שעובדים עם האדופ)
